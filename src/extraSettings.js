...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [0, 0, 1, 2, 1, 3],
  randomFunction: () => {
...
let adLink = '../assets/hb.jpg';//'https://636f-codenav-8grj8px727565176-1256524210.tcb.qcloud.la/yupi_wechat.png';
